...
public class GoogleEarthKMLProvider implements TrackpointListener {
   ...
   */
  public static final String kAltitudeModeAbsolute = "absolute";

  /**
   * A preset value to be used with the <code>setTrackAltitudeMode</code> method.
   */
  public static final String kClampToGround = "clampToGround";
  
  /**
   * A preset value to be used with the <code>setTrackAltitudeMode</code> method.
   */
  public static final String kRelativeToGround = "relativeToGround";
  
  /**
   * The default port 8080 that is used for the HTTP server.
   */
  public static final int kDefaultPort = 8080;
  
  private Trackpath trackpath = new Trackpath();
  private Boolean writeTrack = true;
  private Boolean writePlacemaks = true;
  private String trackAltitudeMode = kAltitudeModeAbsolute;
  private String placemarkAltitudeMode = kAltitudeModeAbsolute;
  ...
  public GoogleEarthKMLProvider(int port) {
    try {
      ...
      System.out.println("IOException in GPSHTTPAccess(): " + e.getMessage());
    }
  }
