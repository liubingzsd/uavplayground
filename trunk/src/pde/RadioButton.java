...
public class RadioButton extends Signal {
  ...
  public void draw() {
    ...
    // draw the button
    if (getValue() == getHigh()) {
      if (!isMouseOver()) applet.fill(Colors.kColorControlOn);
      else applet.fill(Colors.kColorControlHighlighted);
    }
    else if (mouseOver) applet.fill(Colors.kColorControlMouseOver);
    else applet.fill(Colors.kColorControlOff);
