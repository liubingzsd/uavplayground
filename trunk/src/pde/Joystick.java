...
public class Joystick extends ActuatorXY {
  ...
  public void draw() {
    ...
    applet.text(labelX, Fonts.kLineSpacing, Fonts.kLineHeight);
    // draw the label's value
    applet.textFont(Fonts.getFontPlain(applet), Fonts.kFontSize);
    applet.textAlign(PApplet.RIGHT);
    applet.text(String.format("%1.2f", getValueX()), content.getWidth() - Fonts.kLineSpacing, Fonts.kLineHeight);
    applet.popMatrix();
    ...
    applet.textFont(Fonts.getFontBold(applet), Fonts.kFontSize);
    applet.textAlign(PApplet.LEFT);
    applet.text(labelY, Fonts.kLineSpacing, Fonts.kLineHeight);
    // draw the labesl's value
    applet.textFont(Fonts.getFontPlain(applet), Fonts.kFontSize);
    applet.textAlign(PApplet.RIGHT);
    applet.text(String.format("%1.2f", getValueY()), panel.labelRight.getHeight() - Fonts.kLineSpacing, Fonts.kLineHeight);
    applet.popMatrix();
