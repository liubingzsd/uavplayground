...
public class Graph extends Panel {
  ...
  public void addGraph(String label, int color) {
    ...
    setLabelBottomHeight((graphs.size() * Fonts.kLineHeight) + Fonts.kLineSpacing);
  }
  ...
  public void draw() {
    ...
    for (GraphData graph : graphs.values()) {
      ...
      applet.text(graph.label, Fonts.kLineSpacing, Fonts.kLineHeight);
      applet.translate(0, Fonts.kLineHeight);
    }
    applet.popMatrix();
